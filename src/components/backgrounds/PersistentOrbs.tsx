...
export function PersistentOrbs({
  ...
  return (
    ...
    >
      ...
      <div
        className="hidden sm:block absolute top-[65%] left-[15%] w-[450px] h-[450px] rounded-full animate-orb-primary"
        style={{
      ...
      <div
        className="hidden sm:block absolute bottom-[-80px] right-[10%] w-[450px] h-[450px] rounded-full animate-orb-secondary"
        style={{
