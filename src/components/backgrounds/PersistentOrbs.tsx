...
export function PersistentOrbs({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute -top-20 -left-20 w-[550px] h-[550px] sm:w-[700px] sm:h-[700px] rounded-full animate-orb-primary"
        style={{
      ...
      <div
        className="absolute top-[30%] -right-28 w-[500px] h-[500px] sm:w-[650px] sm:h-[650px] rounded-full animate-orb-secondary"
        style={{
      ...
      <div
        className="absolute top-[65%] left-[15%] w-[450px] h-[450px] rounded-full animate-orb-primary"
        style={{
      ...
      <div
        className="absolute bottom-[-80px] right-[10%] w-[450px] h-[450px] rounded-full animate-orb-secondary"
        style={{
