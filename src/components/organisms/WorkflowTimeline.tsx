...
export const WorkflowTimeline = () => {
  ...
  return (
    <section id="workflow" ref={containerRef} className="py-28 md:py-36 relative border-t border-white/[0.06] bg-[#090d14]">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center max-w-2xl mx-auto mb-20 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/[0.04] text-zinc-300 text-xs font-mono">
            <Rocket className="h-3.5 w-3.5 text-indigo-400" /> DEPLOYMENT LIFECYCLE
          </div>
          ...
          <TextReveal as="p" triggerOnScroll delay={0.1} className="text-zinc-400 text-base sm:text-lg">
            ...
            return (
              <div
                ...
                className={`workflow-step-card relative rounded-2xl border p-8 transition-all duration-300 ${
                  isActive
                    ? "border-indigo-500/50 bg-[#0f1522] shadow-[0_10px_35px_rgba(99,102,241,0.12)] -translate-y-1"
                    : "border-white/[0.08] bg-[#0c1017]/60 hover:border-white/20"
                }`}
              >
                {/* Step Top Header */}
