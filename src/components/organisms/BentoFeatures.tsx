...
export const BentoFeatures = () => {
  ...
  return (
    <section id="features" ref={containerRef} className="py-28 md:py-36 relative bg-[#07090e]">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <TextReveal as="h2" triggerOnScroll className="text-3xl sm:text-5xl font-extrabold tracking-tight text-white">
            Built for creators who obsess over details.
          </TextReveal>
          <TextReveal as="p" triggerOnScroll delay={0.15} className="text-zinc-400 text-base sm:text-lg max-w-xl mx-auto">
            ...
            <SpotlightCard className="h-full flex flex-col justify-between" spotlightColor="rgba(99, 102, 241, 0.22)">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-mono px-2.5 py-1 rounded-md bg-white/[0.04] text-zinc-400 border border-white/[0.06]">
                    Interactive Sandbox
                  </span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Dynamic Theme Architecture</h3>
                <p className="text-sm text-zinc-400 mb-6">
                  Switch instantly between carefully calibrated dark palettes designed with optical contrast and typography rhythm.
                </p>
                  ...
                  {themeOptions.map((t, idx) => (
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-lg border transition-all duration-200 font-mono flex items-center gap-1.5 ${
                        selectedTheme === idx
                          ? `${t.border} bg-white/[0.08] text-white shadow-sm`
          ...
          <div className="bento-card-item md:col-span-1">
            <SpotlightCard className="h-full flex flex-col justify-between" spotlightColor="rgba(16, 185, 129, 0.18)">
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-2">Sub-second Latency</h3>
                <p className="text-sm text-zinc-400 mb-6">
                  Turbopack-powered SSR compilation served at global edge nodes with instant cached TTFB.
                </p>
              </div>

              <div className="p-4 rounded-xl bg-[#081310] border border-emerald-500/30 font-mono">
          ...
          <div className="bento-card-item md:col-span-1">
            <SpotlightCard className="h-full flex flex-col justify-between" spotlightColor="rgba(245, 158, 11, 0.18)">
              <div>
                ...
                <h3 className="text-xl font-bold text-white mb-2">Automated OpenGraph</h3>
                <p className="text-sm text-zinc-400 mb-6">
              ...
              <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.08] space-y-2">
                <div className="flex items-center gap-1.5 text-xs text-zinc-300 font-mono">
                  <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" /> Rich Snippet Ready
                </div>
                <div className="flex items-center gap-1.5 text-xs text-zinc-300 font-mono">
                  <CheckCircle2 className="h-3.5 w-3.5 text-emerald-400" /> Semantic JSON-LD
                </div>
              </div>
            </SpotlightCard>
          </div>
            ...
            <SpotlightCard className="h-full flex flex-col justify-between" spotlightColor="rgba(168, 85, 247, 0.2)">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-xs font-mono px-2.5 py-1 rounded-md bg-purple-500/10 text-purple-400 border border-purple-500/20">
                    PWA Offline Sync
                  </span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Zero-Friction Sharing & Native App Mode</h3>
                <p className="text-sm text-zinc-400 mb-6">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 rounded-xl bg-white/[0.03] border border-white/[0.08]">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-mono text-zinc-300">
                    portfoliobuilder.dev/<span className="text-indigo-400">yourname</span>
                  </span>
                </div>
